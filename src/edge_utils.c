...
#ifdef WIN32
                traceEvent(TRACE_DEBUG, "sendto_fd WSAGetLastError(): %u", WSAGetLastError());
#endif
            } else {
                traceEvent(TRACE_WARNING, "sendto_fd sendto failed (%d) %s", errno, c);
#ifdef WIN32
                traceEvent(TRACE_WARNING, "sendto_fd WSAGetLastError(): %u", WSAGetLastError());
#endif
            }
