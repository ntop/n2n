...
/* Max available space to add supernodes' informations (sockets and MACs) in REGISTER_SUPER_ACK
 Field sizes of REGISTER_SUPER_ACK as used in encode/decode functions in src/wire.c */
...
#define ALLOWED_TIME                    20 /* sec, indicates supernodes that are proven to be alive (a.k.a currents) */
